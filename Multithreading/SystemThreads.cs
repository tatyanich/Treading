...
namespace ConsoleApplication1
{
    class SystemThreads
    {
        private class MultThreadData
        {
            public MultThreadData(AutoResetEvent p1, List<Block> treadList, Matrix mas, int b)
            {
                autoEv = p1;
                a = b;
                matr = mas;
    ...
    //            SystemThreads d = new SystemThreads();
